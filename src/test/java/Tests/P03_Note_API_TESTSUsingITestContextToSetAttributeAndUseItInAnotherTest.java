...
public class P03_Note_API_TESTSUsingITestContextToSetAttributeAndUseItInAnotherTest extends P01_LoginAPITest_GenerateAccessToken{
 ...
 //Create New Note Test Method
    ...
    @Test
    public void CreateNewNote(ITestContext context) throws IOException {
       ...
       String CreateNoteResponse=  given().relaxedHTTPSValidation().
        ...
        //Using ITestContext to be able to use id in another test class
        context.setAttribute("NoteId" ,noteId);
